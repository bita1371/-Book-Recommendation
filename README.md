# Book Recommendation :
With over 3.5 billion internet users and growing online retail sales, book recommendation systems play a key role in e-commerce. They suggest books based on user interests, helping customers discover relevant titles quickly. Used by platforms like Amazon and Goodreads, these systems improve user experience and increase sales.
...
I will also use the books dataset to obtain book titles and other information. It contains the following attributes:
...
and the last dataset is users information which contain:
User_id
Location 
Age
